...
- `beta_env_offsize`: a length $K_{\text{offsize}}$ vector of environmental regression coefficients for offspring size
- `beta_env_surv_seedling`: a length $K_{\text{surv}}$ vector of environmental regression coefficients for logit-seedling-survival
- `beta_env_surv_adult`: a length $K_{\text{surv}}$ vector of environmental regression coefficients for logit-adult-survival
- `beta_env_grow`: a length $K_{\text{grow}}$ vector of environmental regression coefficients for growth
- `beta_env_seedheads`: a length $K_{\text{seedhead}}$ vector of environmental regression coefficients for log-seadhead production
- `beta_size_surv_seedling`: a scalar coefficient for the effect of size on logit-seedling-survival
- `beta_size_surv_adult`: a scalar coefficient for the effect of size on logit-adult-survival
- `beta_size_grow`: a scalar coefficient for the effect of size on growth
- `beta_size_flower`: a scalar coefficient for the effect of size on logit-flowering-probability
- `alpha_germ`: a scalar parameter for logit-germination-probability
- `alpha_seeds`: a scalar parameter for log-seed-production
...
offsize <- X_offsize %*% beta_env_offsize
grow <- X_grow %*% beta_env_grow
...
flower <- ilogit(alpha_flower + sizes * beta_size_flower)
...
germination <- ilogit(alpha_germ)
seeds <- exp(alpha_seeds)
