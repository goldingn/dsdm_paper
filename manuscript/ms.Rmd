...
bbs_cov_names <- c("intercept", cache$get("all_covs"))
...
The parameter $\alpha$ represents the product of this constant of proportionality with the individual-level detection rate (fraction of individuals in the population detected in this year of the survey). This yields $\Lambda_i$, the expected number of individuals detected during the survey, which gives the probability $p_i$ of detecting (one or more individuals of) the species $y_i$, under a poisson sampling distribution [@pagelQuantifyingRangewideVariation2014].
...
In the absence of any meaningful prior information for the compound parameter $\alpha$, I assigned it an improper uniform prior on all positive values.
