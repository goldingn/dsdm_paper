...
TODO:
 - change this to have generic intercepts ($\alpha_F$ and $\alpha_S$), then define those intercepts below.
 - reword the below dso that the general formulation doesn't talk about the priors for the intercepts
 - introduce all the parts of the model here first, then have a section below this where we talk about prior ($\alpha_F \sim N(0.58, 0.25 ^ 2)$ etc.)
 - reword the centring of X to make it clear we are centreing against the (weighted) locations where the fecundity and survival estimates were made.
